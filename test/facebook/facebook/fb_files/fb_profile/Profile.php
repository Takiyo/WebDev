...
<?php
	$que_post_bg1=mysqli_query("select * from user_post where user_id=$userid");
...
<table cellspacing="0">
<?php
	$que_post=mysqli_query("select * from user_post where user_id=$userid order by post_id desc");
