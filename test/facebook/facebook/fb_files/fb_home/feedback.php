<?php
	...
	if(isset($_SESSION['fbuser']))
	{
		...
		$que_user_info=mysqli_query("select * from users where Email='$user_email'");
		...
		if(isset($_POST['feedback']))
		{
			...
			mysqli_query("insert into feedback(user_id,feedback_txt,star,Date) values($userid,'$fb_txt','$star','$fb_time')");
		}
		
		if(isset($_POST['delete_feedback']))
		{
			$fb_id=intval($_POST['feedback_id']);
			mysqli_query("delete from feedback where feedback_id=$fb_id");
		}
...
<?php
		$que_feedback=mysqli_query("select * from feedback order by feedback_id desc");
?>
