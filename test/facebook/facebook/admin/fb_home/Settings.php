<?php
	...
	if(isset($_SESSION['fbadmin']))
	{
		...
		$que_admin_info=mysqli_query("select * from admin_info where Username='$admin_user'");
...
<?php
	if(isset($_POST['change_password']))
	{
		...
		{
			mysqli_query("update admin_info set Password='$new_password' where Username='$admin_user'");
		}
		else
		{
